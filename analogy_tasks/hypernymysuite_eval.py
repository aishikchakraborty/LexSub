...
# Datasets!
CORRELATION_EVAL_DATASETS = [("hyperlex", "unsup_datasets/hyperlex_rnd.tsv")]

SIEGE_EVALUATIONS = [
    ("bless", "unsup_datasets/bless.tsv"),
    ("leds", "unsup_datasets/leds.tsv"),
    ("eval", "unsup_datasets/eval.tsv"),
    ("weeds", "unsup_datasets/wbless.tsv"),
    ("shwartz", "unsup_datasets/shwartz.tsv"),
]
...
def bless_directionality_setup(model):
    ...
    """
    # load up the data
    ds = Dataset("unsup_datasets/bless.tsv", model.vocab)
...
def wbless_setup(model):
    ...
    """
    ds = Dataset("unsup_datasets/wbless.tsv", model.vocab)
...
def bibless_setup(model):
    ...
    """
    ds = Dataset("unsup_datasets/bibless.tsv", model.vocab)
